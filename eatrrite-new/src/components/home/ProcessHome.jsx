...
import { ClipboardCheck, Handshake, PersonStanding, Utensils } from "lucide-react";
import { PillLabel } from "@/shared/components/PillLabel";
import { SplitTitle } from "@/shared/components/SplitTitle";
import { Reveal } from "@/shared/components/Reveal";

const icons = [ClipboardCheck, Utensils, PersonStanding, Handshake];

export function ProcessHome({ data }) {
  return (
    <section className="bg-brand/5 py-16 md:py-24">
      <div className="container-er space-y-10">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {data.steps.map((step, index) => {
            ...
            return (
              <Reveal key={step.num} y={56} duration={0.9} amount={0.3}>
