<h2 style="margin:0 0 12px;font-family:Georgia,'Times New Roman',serif;font-size:24px;line-height:1.25;color:#014e4e;">Reminder: complete your questionnaire</h2>
<p style="margin:0 0 22px;font-size:15px;line-height:1.65;color:#595b62;">
    ...
    your Eat Rrite consultation is reserved. We still need your questionnaire before we can send the Google Meet link.
</p>
...
<p style="margin:26px 0 14px;font-size:15px;color:#1c2029;">
    Complete the questionnaire to get your Google Meet link. This reminder stops as soon as you submit the form.
</p>

<p style="margin:0;">
    <a href="<?php echo htmlspecialchars((string) $data['questionnaire_url'], ENT_QUOTES, 'UTF-8'); ?>"
...
<p style="margin:16px 0 0;font-size:13px;color:#819291;word-break:break-all;">
    <?php echo htmlspecialchars((string) $data['questionnaire_url'], ENT_QUOTES, 'UTF-8'); ?>
</p>
