...
/**
 * Thin client for the deployed Google Apps Script web app.
 * PHP never opens the Spreadsheet directly — only these actions:
 *   list | book | list_disabled_slots | set_disabled_slot
 */
final class GoogleAppsScriptClient
{
    ...
    public function listAppointments(): array
    {
        ...
        $response = $this->call(['action' => 'list']);
    ...
    public function listDisabledSlots(): array
    {
        ...
        $response = $this->call(['action' => 'list_disabled_slots']);
