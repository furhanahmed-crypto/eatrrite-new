...
export const snackbarContent = [
  ...
  },
  {
    ...
    items: [
      {
        title: "Diet-perfect recipe",
        text: "Built to sit beside dal-chawal and idli-dosa, not against them. One bar that respects the Eat Rrite plate.",
      },
      {
        title: "Only real food",
        text: "Dates, oats and almonds. Nothing you cannot name. Nothing that spikes you and leaves you hungry an hour later.",
      },
      {
        title: "Proudly Eat Rrite",
        text: "The same food-as-medicine thinking as our programmes — now in a bar you can carry, gift, or keep on the kitchen counter.",
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Dates",
        text: "Natural sweetness and minerals, so the bar tastes generous without refined sugar running the show.",
      },
      {
        name: "Oats",
        text: "Slow fibre that keeps you full and steady — the kind of energy a real diet can trust between meals.",
      },
      {
        name: "Almonds",
        text: "Healthy fat and crunch. Satiety that feels like food, not a packaged sweet pretending to be wellness.",
      },
    ],
  },
  {
    ...
    items: [
      {
        num: "01",
        title: "Fits the Eat Rrite diet",
        text: "It does not fight your meals. It fills the honest gap — travel, clinic days, late evenings — without a crash.",
      },
      {
        num: "02",
        title: "Science you can taste",
        text: "Whole food first, always. No isolate powders, no unreadable labels, no 30-day gimmick in bar form.",
      },
      {
        num: "03",
        title: "One bar, done beautifully",
        text: "We did not launch a flavour wall. We made one bar we would eat ourselves — and recommend to someone we love.",
      },
    ],
  },
  {
